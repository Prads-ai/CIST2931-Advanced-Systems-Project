...
/**
 * **************************************************************************************************************
 * - CreateAccountPatientServlet : - Get the values of all the
 * Patient_Register.jsp form - Create and call the insertDB from the patient
 * class - Forward the current patient to the patient_login jsp page
 * ***************************************************************************************************************
 */
