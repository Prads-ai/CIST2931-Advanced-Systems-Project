 ...
 * @author pach3
 */
@WebServlet(urlPatterns = {"/LoginChiropractorServlet"})
public class LoginChiropractorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          if(chiroprac_id.equals(cc.getchiroprac_id()) && password.equals(cc.getPassword())){
              
              sess.setAttribute("cc",cc);
              RequestDispatcher dispatcher = request.getRequestDispatcher("test_chiropr_dashboard.jsp");
