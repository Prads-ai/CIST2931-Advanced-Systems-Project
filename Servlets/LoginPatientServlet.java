...
/**
 * **************************************************************************************************************
 * - LoginPatientServlet : Get the values of all the fields of the
 * patient_login.jsp form Create and call the selectDB from the patient class
 * Get the patient id and name from the selectDB method Validate the
 * authenticity of the patient Forward the current patient to the
 * patient_dashboard page or to an error page if there is a credential problem
 * ***************************************************************************************************************
 */
