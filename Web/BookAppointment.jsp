...
<body>  
    ...
    <div class="container-fluid">
      <div class="container">
             <button class="btn btn-secondary mt-2 d-none"type="button" >ADD AN APPOINTMENT</button>
          ...
          <form action="BookAppointmentServlet" method="POST">
              ...
              <p>
                ...
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                 <button type="submit" class="btn btn-secondary"  name="submit">Confirm Appointment</button>
          </form> 
      </div>
  </div>
</div>
