<%-- 
    Document   : NoAppointmentDashboard
    Created on : Oct 24, 2022, 8:19:18 PM
    Author     : pach3
--%>
...
<html lang="en">
    ...
    <body>  
                        ...
                        <ul class="navbar-nav mb-2 ms-auto">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="UpdateChiropractorInfo_II.jsp">Update Profile</a></li>
        ...
        <div class="container-fluid">
            <div class="container">
                <button class=" d-none btn btn-secondary mt-2" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"> Recent Appointment</button>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col">
                        <table class=" shadow table table-striped custab" style="width:100%">
                            ...
                            <tr>
                                <td>No appointment at this time</td>
                                <td>No data </td>
                                <td>No data</td>
                                <td>No data</td>
                                <td>No data</td>
                    ...
                    <div class="col-3">
                        <div class="card shadow-sm" style="width: 18rem; position: relative; bottom: 12rem;">
                            ...
                            <div class="card-body">
                                <a href="UpdateChiropractorInfo_II.jsp"  class="text-center text-decoration-none card-link"><button class=" ms-5 btn btn-info">Update profile</button></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                    <h6>Appointment Date Time : </h6> No Appointment at this time>
                    </p>
                    <p>
                    <h6>Patient ID : </h6> No data>
                    </p>
                    <p>
                    <h6>Procedure Code : </h6> No data>
                    </p>
                    <p>
                    <h6>Office Number : </h6> 0>
                    </p>
                </div>
