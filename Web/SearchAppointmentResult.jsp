...
<html lang="en">
    ...
    <body>  
        <%
            ...
            Appointments appt = (Appointments) session.getAttribute("appointmentResult");
        %>
        ...
        <div class="container-fluid">
            <div class="container">
                <button class="btn btn-secondary mt-2"type="button" class="btn btn-primary"> <a href="BookAppointment.jsp" class="text-white text-decoration-none"><a href="patient_dashboard.jsp" class="text-white text-decoration-none">Go back to dashboard</a></button>
                <div class="row mt-5">
                    ...
                    <div class="col">
                        ...
                        <table class="table table-striped custab" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td><%= appt.getOfficeNum()%></td>
                                <td class="d-none text-center">
                                    <a class='btn btn-info btn-xs' href="PatientEditAppointmentServlet?id=<%=appt.getId()%>"><span class="glyphicon glyphicon-edit "></span> Edit</a>
                    ...
                    <!--New Column-->
                    <div class="col-3">
                        <div class="card" style="width: 18rem; position: relative; bottom: 12rem;">
                            <img
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><%=currentPatient.getAddress()%></li>
                                <li class="list-group-item"><%=currentPatient.getCity()%></li>
                                <li class="list-group-item"><%=currentPatient.getState()%></li>
                                <li class="list-group-item"><%=currentPatient.getZip()%></li>
                            </ul>
                            <div class="card-body">
