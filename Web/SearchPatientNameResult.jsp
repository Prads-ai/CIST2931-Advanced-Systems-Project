...
<html lang="en">
    ...
    <body>  
        ...
        <div class="container-fluid">
            <div class="container">
                <button class="btn btn-secondary mt-2"type="button" class="btn btn-primary"> <a href="" class="text-white text-decoration-none"><a href="chiropractor_dashboard.jsp" class="text-white text-decoration-none">Go back to dashboard</a></button>
                <div class="row mt-5">
                    ...
                    <div class="col">
                        ...
                        <table class="table table-striped custab" style="width:100%">
                            <thead class="thead-light" style="background-color: greenyellow;">
                                <tr>
                                    <th>Appointment</th>
                                    <th>Patient name</th>
                    ...
                    <div class="col-3">
                        <div class="card" style="width: 18rem; position: relative; bottom: 12rem;">
                            ...
                            <div class="card-body">
                                <h5 class="text-center card-title">Personal Information</h5>
                            </div>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><%=chiro.getfirstName()%></li>
