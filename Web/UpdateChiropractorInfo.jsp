            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <form class="form-card" action ="UpdateChiropractorInfoServlet" method="POST" >
                            <div class="row justify-content-between text-left">
                                ...
                                <div class="row justify-content-around">
                                    <div class="form-group col-sm-4"> <a href="chiropractor_dashboard.jsp"><button class="btn-block btn-lg btn-secondary" >Save</button> </a></div>
                                </div>
                            </div>
