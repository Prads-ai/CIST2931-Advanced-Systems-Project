...
<%@page import="Business_Object.Procedure"%>
                        ...
                        <ul class="navbar-nav mb-2 ms-auto">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="d-none dropdown-item" href="UpdatePatientInfo.jsp">Update Profile</a></li>
                                    <li><a class="d-none dropdown-item" href="#">View Appointments</a></li>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col">
                        <%
                            ...
                            if (!appl.isEmpty()) {
                                ...
                                for (Appointments a : appl) {
                                    ...
                                    chiro.selectDB(a.getChiropractorId());
                                    count++;
                        %>
                        <table class=" shadow table table-striped custab" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td><%=chiro.getfirstName()%></td>
                                <td data-toggle="tooltip" data-placement="right" title="<%= proc.toString()%>"><%= a.getProcCode()%></td>
                    ...
                    <div class="col-3">
                        <div class="card shadow-sm" style="width: 18rem; position: relative; bottom: 12rem;">
                            ...
                            <div class="card-body">
                                <a href="UpdatePatientInfo.jsp" class="text-center text-decoration-none card-link"><button class=" ms-5 btn btn-info">Update profile</button></a>
                            </div>
                        </div>
                    </div>
                </div>
